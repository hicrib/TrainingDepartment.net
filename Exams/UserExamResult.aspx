<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ExamsMaster.Master" AutoEventWireup="true" CodeBehind="UserExamResult.aspx.cs" Inherits="AviaTrain.Exams.UserExamResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="tbl_result">
        ...
        <tr>
            ...
            <td><asp:Image ID="img_result" runat="server" />
