<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ExamsMaster.Master" AutoEventWireup="true" CodeBehind="TraineeMain.aspx.cs" Inherits="AviaTrain.Exams.Exam_MainGeneral" %>
                ...
                <ul class="tabs">
                    <div style="text-align: center;">
                        <li class="tab-link current" data-tab="tab-0">
                            <div style="width: 200px; height: 30px; border: 1px solid black; display: inline-block; font-size: x-large;">
                                Training Reports
                            </div>
                        </li>
