...
{
    public partial class TR_ARE_APP_RAD : MasterPage
    {
        ...
        protected void fill_View_Mode_as(string reportid)
        {
            ...
            Dictionary<string, DataTable> li = DB_Reports.pull_TR_ARE_APP_RAD(reportid);
        ...
        {
            //POSITION field fill
            ddl_positions.DataSource = DB_System.get_APP_ACC_Positions();
        ...
        protected string push_into_db()
        {
            ...
            string reportid = DB_Reports.push_Training_Report("1", data);
            return reportid;
        }
        ...
        protected bool Check_Page_Elements()
        {
            ...
            {
                string pos = ddl_positions.SelectedValue; //NRX->NR
                if (pos.Length == 3)
                    pos = pos.Substring(0, 2);
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            ...
            if (lbl_viewmode.Text == "trainee")
            {
                ...
                if (DB_Reports.update_TraineeSigned(lbl_reportnumber.Text, txt_studentcomments.Text, "1")) //signed, commented and reporttype:1
                {
